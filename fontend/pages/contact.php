    ...
    <main role="main" class="mb-2">
        ...
        if (isset($_POST['btnGoiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'nguyenanhthoai99@gmail.com'; // SMTP username
                $mail->Password = 'yjxjsnydxklwgkeq';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('nguyenanhthoai99@gmail.com', 'Mail Liên hệ');
                $mail->addAddress('duchuy.huynh.413@gmail.com');               // Add a recipient
